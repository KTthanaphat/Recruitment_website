    ...
    <Panel>
      ...
      {rows.length === 0 ? (
        ...
        <div className="grid gap-3">
          {rows.map((row) => (
            <article key={row.log_id} className="rounded-md border border-[#D7DEE8] bg-white p-4">
              ...
              <details className="rounded-md bg-lightgray/65 p-3 text-sm">
                <summary className="cursor-pointer font-extrabold text-primary">View JSON change</summary>
