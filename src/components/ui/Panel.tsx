...
const panelVariants: Record<PanelVariant, string> = {
  default: "border border-[#D7DEE8] bg-white p-5 shadow-[0_4px_14px_rgba(11,19,43,0.025)]",
  section: "border border-[#D7DEE8] bg-white p-5 shadow-[0_4px_14px_rgba(11,19,43,0.025)]",
  subtle: "border border-[#D7DEE8] bg-[#F8FAFD] p-4 shadow-none",
  report: "border border-[#D7DEE8] bg-white py-6 shadow-[0_4px_14px_rgba(11,19,43,0.025)]"
};
