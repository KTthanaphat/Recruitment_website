...
create table if not exists public.sourcing_weekly_updates (
  ...
  applicants_jobbkk integer not null default 0 check (applicants_jobbkk >= 0),
...
begin
  ...
  values (
    ...
    coalesce(nullif(payload ->> 'applicants_jobbkk', '')::integer, 0),
...
begin
  ...
  insert into public.candidates (candidate_id, name, nickname, phone_no, email, doc_group_id, channel, ref_name, first_contact_date, candidate_folder_url)
  values (
    v_candidate_id,
    nullif(payload ->> 'name', ''),
    v_nickname,
